...
author:
  - "Dr. Andrew Finley"
  - "Dr. Jeffrey Doser<br>Michigan State University, East Lansing, Michigan"
...
## Course schedule Materials (download all in one [zip](casanr23.zip) or [tar.gz](casanr23.tar.gz))
...
* 8:30 - 10:00 Introduction to Point-referenced Spatial Data 
  * Introduction to Geostatistics [slides](slides/IntroToGeostatistics.pdf)
      * Exercise 1
        * [Markdown doc](exercises/exercise-1/exercise_1.html)
        * Code [zip](exercises/exercise-1.zip) or [tar.gz](exercises/exercise-1.tar.gz)
  * Bayesian Spatial Linear Regression [slides](slides/Bayesian_Spatial_Linear_Regression.pdf)
      * Exercise 2
...
* 10:30 - 12:00 High-dimensional Bayesian Geostatistics
  * Low-rank models and the Predictive Process [slides](slides/Low_Rank_Predictive_Process.pdf)
  * Sparsity composite likelihoods and the Nearest Neighbor Gaussian Process (NNGP) [slides](slides/SpatialNNGP.pdf)
  * Advanced computing environments [slides](slides/CompNotes.pdf)
    * Exercise 3
...
* 1:30 - 2:00 Modeling non-Gaussian Spatial Data [slides](slides/SpatialGLMMs.pdf)
* 2:00 - 3:00 Spatial Factor Models for Multivariate Spatial Data [slides](slides/SpatialFactorModels.pdf)
  * Exercise 4
...
* 3:30 - 4:30 Application of Spatially-Varying Coefficient Models [slides](slides/SVCs.pdf)
    * Exercise 5
      ...
      * Code [zip](exercises/exercise-4.zip) or [tar.gz](exercises/exercises-4.tar.gz)
