...
#' 
## ---- fig.cap = 'Predictor variables (centered and scaled)', fig.fullwidth = TRUE, fig.align = 'center'----
...
#' 
## ---- fig.cap = 'Traceplots for hyper-mean parameters', fig.align = 'center'----
# Components stored in the resulting model object
names(out)
plot(out$beta.comm.samples, density = FALSE)

#' 
## ---- fig.cap = 'Traceplots for the first nine-species intercepts', fig.align = 'center'----
plot(out$beta.samples[, 1:9], density = FALSE)

#' 
## ---- fig.cap = 'Traceplots for the nine estimated loadings for the first spatial factor', fig.align = 'center'----
plot(out$lambda.samples[, 2:10], density = FALSE)

#' 
## ---- fig.cap = 'Traceplots for occurrence probabilities for nine species at one forest plot', fig.align = 'center'----
plot(mcmc(out$psi.samples[, 1:9, 10]), density = FALSE)

#' 
## ---- fig.cap = 'Traceplots for spatial decay parameters for the three spatial factors', fig.align = 'center'----
