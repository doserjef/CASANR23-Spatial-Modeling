...
```{r fit_latent_nngp, fig.align="center", message=FALSE}
library(spNNGP)
...
```{r harvard_forest_data, message=FALSE}
library(geoR)
library(raster)
library(leaflet)
...
```{r reproject_and_map, warning=FALSE}
...
```{r variogram_eda, fig.align="center"}
sub <- 1:10000
...
```{r predict_for_holdout, fig.align="center"}
